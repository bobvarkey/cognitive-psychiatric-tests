    ...
    <footer className={`border-t mt-12 ${dark ? 'bg-black border-white/10' : 'bg-gray-50'}`}>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#help" className={`flex items-center gap-2 ${dark ? 'text-gray-400 hover:text-fuchsia-400' : 'text-gray-600 hover:text-blue-600'}`}>
                  <Info className="h-4 w-4" />
                  Help & Support
                </a>
              </li>
              <li>
                <a href="#privacy" className={`flex items-center gap-2 ${dark ? 'text-gray-400 hover:text-fuchsia-400' : 'text-gray-600 hover:text-blue-600'}`}>
                  <Shield className="h-4 w-4" />
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="#terms" className={`flex items-center gap-2 ${dark ? 'text-gray-400 hover:text-fuchsia-400' : 'text-gray-600 hover:text-blue-600'}`}>
        ...
        <div className={`border-t pt-8 ${dark ? 'border-white/10' : 'border-gray-200'}`}>
          {/* Bottom Info */}
          <div className={`flex flex-col md:flex-row justify-between items-center text-sm gap-4 ${dark ? 'text-gray-400' : 'text-gray-600'}`}>
            <div>
            ...
            {/* Version & Status */}
            <div className={`text-right text-xs ${dark ? 'text-gray-600' : 'text-gray-500'}`}>
